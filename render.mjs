...
const FONTS = "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1"
...
<nav class="top">
  ...
  <a href="${BASE}/compare/">Compare countries</a>
...
const CALCULATOR_SCRIPT = `<script type="module">
import { takeHome, money } from "${BASE}/js/tax.mjs";
import { PERSONAL_ALLOWANCE } from "${BASE}/js/rates.mjs";
